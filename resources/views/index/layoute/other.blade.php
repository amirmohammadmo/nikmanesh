        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="owl-features owl-carousel owl-loaded owl-drag">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transition: all 0s ease 0s; width: 6006px; transform: translate3d(-1251px, 0px, 0px);"><div class="owl-item cloned" style="width: 470.5px; margin-right: 30px;"><div class="item">
                                    <img src="assets/images/projects-04.jpg" alt="">
                                    <div class="down-content">
                                        <h4>HTML CSS Layouts for your websites</h4>
                                        <a href="#"><i class="fa fa-link"></i></a>
                                    </div>
                                </div></div><div class="owl-item cloned" style="width: 470.5px; margin-right: 30px;"><div class="item">
                                ...
                                </div></div><div class="owl-item active center" style="width: 470.5px; margin-right: 30px;"><div class="item">
                                    <img src="assets/images/projects-01.jpg" alt="">
                                    <div class="down-content">
                                        <h4>Digital Agency HTML Templates</h4>
                                        <a href="#"><i class="fa fa-link"></i></a>
                                    </div>
                                </div></div><div class="owl-item active" style="width: 470.5px; margin-right: 30px;"><div class="item">
                                    <img src="assets/images/projects-02.jpg" alt="">
                                    <div class="down-content">
                                        <h4>Admin Dashboard CSS Templates</h4>
                                        <a href="#"><i class="fa fa-link"></i></a>
                                    </div>
                                </div></div><div class="owl-item" style="width: 470.5px; margin-right: 30px;"><div class="item">
                                    <img src="assets/images/projects-03.jpg" alt="">
                                    <div class="down-content">
